<nav class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow " style="background-color: rgb(4, 12, 73)">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600  d-sm-inline">{{ auth()->user()->name }}</span>
               @if(auth()->user()->profiles)
  
@auth
<img src="{{asset('/storage/profile/'.auth()->user()->profiles->image)}}" alt="profile"style="border-radius: 50%;width:35px;height:35px;margin-left:10px" class="border"/>
